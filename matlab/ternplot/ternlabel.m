...
r(1) = text(0.5, -0.05, A, 'horizontalalignment', 'center','Interpreter','latex', 'FontSize', 14);
r(2) = text(1-0.45*sin(deg2rad(30)), 0.5, B, 'rotation', -60, 'horizontalalignment', 'center','Interpreter','latex', 'FontSize', 14);
r(3) = text(0.45*sin(deg2rad(30)), 0.5, C, 'rotation', 60, 'horizontalalignment', 'center','Interpreter','latex', 'FontSize', 14);
